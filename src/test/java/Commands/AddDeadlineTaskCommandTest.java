...
public class AddDeadlineTaskCommandTest {
    ...
    public void execute_validInput_success() {
        ...
        assertEquals(expectedOutputToString.toString(), toDoList.get(1).toString(), "The added deadline task has the correct description and deadline");
    }

    @Test
    public void execute_emptyArgsInput_printErrorMessage() {
        String emptyInput = "deadline";
        String expectedMessage = "Thou hast overlooked the noble task of bestowing a worthy description upon this endeavor!\n(Looks like you forgot to input a description and a deadline! Try again)\n";
